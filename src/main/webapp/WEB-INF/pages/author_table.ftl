        ...
        <section class="content">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Добавить писателя/поэта</h3>
                ...
                <!-- form start -->
                <form class="form-horizontal" enctype="multipart/form-data" action="/tables/authors" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea  rows="10" class="form-control" name="info" placeholder="Информация">
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group">
